...
if __name__ == '__main__':
    ...
    image_list, _, _ = file_utils.get_files(params['test_folder'])
    result_folder = './result/'
    net = CRAFT()
    ...
    for k, image_path in enumerate(image_list):
        ...
        bboxes, polys, score_text = test_net(net, image, params['text_threshold'], params['link_threshold'], params['low_text'], params['cuda'], params['poly'], params['canvas_size'], params['mag_ratio'])
